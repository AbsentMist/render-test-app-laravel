...
export default {
   ...
   * ainsi que l'état d'ouverture du menu d'export.
   * @author Guillermet Jean-Daniel
   * @returns {{menuExportOuvert: boolean, filtresInternes: {recherche: string, status: string, type: string}}}
   */
  data() {
    return {
  ...
  methods: {
     ...
     * @param {string} type Type d'export demandé ('email', 'logistique', 'banque').
     * @returns {void}
     */
    exporter(type) {
  ...
  /**
   * Attache un listener global pour fermer le menu d'export
   * lors d'un clic en dehors du composant.
   */
  mounted() {
  ...
  /**
   * Supprime le listener global pour éviter les fuites mémoire.
   */
  beforeUnmount() {
