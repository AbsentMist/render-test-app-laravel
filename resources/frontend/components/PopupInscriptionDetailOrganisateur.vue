<template>
    ...
    >
        <div
            :class="
                inline
                    ...
                    : 'relative bg-white rounded-2xl shadow-2xl w-full max-w-8xl mx-4 flex flex-col overflow-hidden'
            "
        ...
        >
            ...
            <div
                v-if="!inline"
                class="flex items-center justify-between px-6 pt-5 pb-0 border-b border-gray-100 bg-tertiary-900"
            >
                <div class="flex flex-col w-full">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            <div>
                                <span
                                    class="px-6 text-subtitle font-medium text-secondary"
                                    >Detail inscription</span
                                >
                                <div
                            ...
                            <span
                                v-if="isEdit"
                                class="flex items-center gap-1.5 bg-amber-100 text-amber-800 text-xs font-bold px-3 py-1 rounded-full"
                            >
                                <Icon icon="mdi:pencil" class="w-3 h-3" /> Mode
                                modification
                            </span>
                        </div>
                        <button
                            @click="$emit('close')"
                            class="text-secondary hover:text-gray-600 transition-colors mr-1 self-start mt-1"
                        >
            ...
            <div class="flex-1 overflow-y-auto pb-20">
                ...
                <div v-if="activeTab === 'general'" class="p-6 space-y-6">
                    ...
                    <section>
                        ...
                        <div
                            class="bg-gray-50 rounded-xl p-4 grid grid-cols-2 md:grid-cols-4 gap-4"
                        >
                            <div>
                            ...
                            <div>
                                ...
                                <p class="font-medium text-gray-800">
                                    {{
                                        inscription.participant.sexe === "M"
                                            ? "Homme"
                                            : "Femme"
                                    }}
                                </p>
                    ...
                    <section>
                        ...
                        <div
                            class="bg-gray-50 rounded-xl p-4 grid grid-cols-2 md:grid-cols-6 gap-4"
                        >
                            <div>
                    ...
                    <section>
                        ...
                        <div
                            class="bg-gray-50 rounded-xl p-4 grid grid-cols-2 md:grid-cols-5 gap-4"
                        >
                            <div
                                v-if="
                                    inscription.groupe ||
                                    inscription.participant.equipe_nom
                                "
                                class="col-span-2 md:col-span-5 flex gap-3"
                            >
                                <div
                                    v-if="inscription.groupe"
                                    class="bg-white rounded-full py-0.5 px-3 border border-gray-200 inline-flex items-center gap-2"
                                >
                                    <Icon
                                ...
                                <div
                                    v-if="inscription.participant.equipe_nom"
                                    class="bg-white rounded-full py-0.5 px-3 border border-gray-200 inline-flex items-center gap-2"
                                >
                                    <Icon
                            ...
                            <div>
                                ...
                                <select
                                    v-if="isEdit"
                                    v-model="inscriptionEdit.status_paiement"
                                ...
                                <span
                                    ...
                                    :class="
                                        inscription.status_paiement === 'Validé'
                                            ? 'bg-green-100 text-green-700'
                            ...
                            <div>
                                ...
                                <input
                                    v-if="isEdit"
                                    v-model="inscriptionEdit.date_paiement"
                                    type="datetime-local"
                                    class="mt-1 text-xs border border-gray-300 rounded px-2 py-1 bg-white w-full"
                                />
                                <p v-else class="font-medium text-gray-800">
                            ...
                            <div>
                                ...
                                >
                                    <input
                                        v-model="inscriptionEdit.montant_rabais"
                                        type="number"
                                        class="text-sm border border-gray-300 rounded px-2 py-1 w-24 bg-white"
                                    />
                                    <span class="text-xs text-gray-400"
                                ...
                                <p v-else class="font-medium text-gray-800">
                                    {{ inscription.montant_rabais }} CHF
                                </p>
                            </div>
                                    ...
                                    <span
                                        v-if="
                                            inscription.dossard
                                                ?.nom_personnalise
                                        "
                                        class="ml-1 text-xs text-blue-600 font-semibold"
                                    >
                                        ({{
                                            inscription.dossard
                                                .nom_personnalise
                            ...
                            <div>
                                ...
                                <input
                                    v-if="isEdit"
                                    v-model="inscriptionEdit.numero_inscription"
                                    type="text"
                            ...
                            <div>
                                ...
                                <input
                                    v-if="isEdit"
                                    v-model="inscriptionEdit.ref_groupage"
                                    type="text"
                                    class="mt-1 text-sm rounded px-2 py-1 w-full bg-white border border-gray-300"
                                />
                                <p v-else class="font-medium text-gray-800">
                                    {{ inscription.ref_groupage ?? "—" }}
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <select
                                    v-if="isEdit"
                                    v-model="
                                        inscriptionEdit.participe_challenge
                                    "
                                ...
                                <p v-else class="font-medium text-gray-800">
                                    {{
                                        inscription.participe_challenge
                                            ? "Oui"
                                            : "Non"
                                    }}
                                </p>
                            ...
                            <div>
                                ...
                                <input
                                    v-if="isEdit"
                                    v-model="inscriptionEdit.equipe_challenge"
                                    type="text"
                                    class="mt-1 text-sm border border-gray-300 rounded px-2 py-1 w-full bg-white"
                                />
                                <p v-else class="font-medium text-gray-800">
                            ...
                            <div>
                                ...
                                <input
                                    v-if="isEdit"
                                    v-model="inscriptionEdit.code_participant"
                                    type="text"
                                    class="mt-1 text-sm border border-gray-300 rounded px-2 py-1 w-full bg-white"
                                />
                                <p v-else class="font-medium text-gray-800">
                            ...
                            <div>
                                ...
                                <select
                                    v-if="isEdit"
                                    v-model="
                                        inscriptionEdit.avertissement_valide
                                    "
                                    class="mt-1 text-xs border border-gray-300 rounded px-2 py-1 bg-white"
                                >
                                    <option :value="true">Oui</option>
                                ...
                                <p v-else class="font-medium text-gray-800">
                                    {{
                                        inscription.avertissement_valide
                                            ? "Oui"
                                            : "Non"
                                    }}
                                </p>
                    ...
                    <section
                        v-if="inscription.ancienne_inscription"
                        class="border-l-2 border-tertiary pl-2"
                    >
                        <h3
                            class="text-sm font-semibold text-gray-400 uppercase tracking-wider mb-3 flex items-center gap-2"
                        >
                            <Icon icon="mdi:history" class="w-4 h-4" /> Ancienne
                            inscription
                        </h3>
                        <div class="p-2">
                            <h3
                                class="text-sm font-semibold text-gray-400 uppercase tracking-wider mb-3 flex items-center gap-2"
                            >
                                <Icon icon="mdi:run-fast" class="w-4 h-4" />
                                Course
                            </h3>
                            <div
                                class="bg-gray-50 rounded-xl p-4 grid grid-cols-2 md:grid-cols-6 gap-4"
                            >
                                <div>
                                    ...
                                    <p class="font-medium text-gray-800">
                                        {{
                                            inscription.ancienne_inscription
                                                .course?.nom ?? "—"
                                        }}
                                    </p>
                                </div>
                        ...
                        <div
                            class="bg-gray-50 rounded-xl p-4 grid grid-cols-2 md:grid-cols-5 gap-4 mt-2"
                        >
                            <div
                                v-if="
                                    inscription.ancienne_inscription.groupe ||
                                    inscription.ancienne_inscription.participant
                                        ?.equipe_nom
                                "
                                class="space-y-4"
                            >
                                <div
                                    v-if="
                                        inscription.ancienne_inscription.groupe
                                    "
                                    class="rounded-full py-0.5 px-2 inline-block"
                                >
                            ...
                            <div>
                                ...
                                <p class="font-medium text-gray-800">
                                    {{
                                        inscription.ancienne_inscription.tarif
                                    }}
                                    CHF
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p class="font-medium text-gray-800">
                                    {{
                                        inscription.ancienne_inscription.dossard
                                            ?.numero ?? "—"
                                    }}
                                </p>
                            </div>
                    ...
                    <section>
                        ...
                        <div
                            v-if="inscription.course.document_description"
                            class="my-2"
                        >
                            <span class="text-sm text-gray-600">{{
                                inscription.course.document_description
                            }}</span>
                        </div>
                        <div class="bg-gray-50 rounded-xl p-4">
                            <div
                                v-if="
                                    inscription.documents_fournis &&
                                    inscription.documents_fournis.length > 0
                                "
                                class="space-y-3"
                            >
                                <div
                                    v-for="doc in inscription.documents_fournis"
                                    :key="doc.id"
                                ...
                                >
                                    ...
                                    <div class="flex items-center gap-2">
                                        <button
                                            ...
                                            "
                                            class="p-2 text-primary hover:bg-gray-100 rounded transition-colors"
                                            title="Télécharger"
                                        >
                                            <Icon
                                                icon="mdi:download"
                    ...
                    <div class="space-y-4">
                        ...
                        >
                            ...
                            >
                                {{
                                    isEdit
                                        ? "Cliquez sur une option pour la sélectionner / désélectionner"
                                        : "Options disponibles"
                                }}
                            </h4>
                            <div class="space-y-2">
                                <div
                                    v-for="option in coursComplet.options"
                                    :key="'opt-' + option.id"
                ...
                <div v-if="activeTab === 'questions'" class="p-6">
                    <div
                        v-if="
                            ...
                            coursComplet.questionnaire.length > 0
                        "
                        class="space-y-4"
                    >
                        <p
                            v-if="isEdit"
                            class="text-xs text-accent-600 font-medium flex items-center gap-1"
                        >
                            <Icon
                        ...
                        <div
                            v-for="question in coursComplet.questionnaire"
                            :key="'q-' + question.id"
                            class="bg-gray-50 rounded-xl p-4 border transition-colors"
                            :class="
                                isEdit ? 'border-accent-200' : 'border-gray-200'
                            "
                        >
                                ...
                                <div
                                    ...
                                    :class="[
                                        reponseQuestionEdit(
                                            ...
                                            ? 'bg-tertiary-300 text-primary'
                                            : 'text-gray-700',
                                        isEdit
                                            ? 'cursor-pointer hover:bg-accent-50 hover:border hover:border-accent-600'
                                            : '',
                                    ]"
                                    @click="
                                        isEdit &&
                    ...
                    >
                        ...
                        />
                        <p class="text-sm">
                            Aucune question associée à cette course.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div
                class="absolute bottom-0 left-0 right-0 border-t px-6 py-3 flex items-center justify-between transition-colors z-10"
                :class="
                    isEdit
...
export default {
    ...
    methods: {
        ...
        activerEdition() {
            ...
            this.inscriptionEdit = {
                ...
                choix_options: JSON.parse(
                    JSON.stringify(this.inscription.choix_options ?? []),
                ),
                reponses_questions: JSON.parse(
                    JSON.stringify(this.inscription.reponses_questions ?? []),
                ),
            };
        },
        ...
        async sauvegarderEdition() {
            try {
                await inscriptionService.updateInscriptionAdmin(
                    this.inscription.id,
                    {
                        ...
                        avertissement_valide:
                            this.inscriptionEdit.avertissement_valide,
                    },
                );

                const choixInitiaux = this.inscription.choix_options ?? [];
                const choixEdites = this.inscriptionEdit.choix_options ?? [];
                const mapInitiaux = new Map(
                    choixInitiaux.map((c) => [c.id_option, c]),
                );
                const mapEdites = new Map(
                    choixEdites.map((c) => [c.id_option, c]),
                );
                ...
                for (const choix of choixInitiaux) {
                    if (!mapEdites.has(choix.id_option)) {
                        await choixOptionOrganisateurService.deleteChoix(
                            this.inscription.id,
                            choix.id_option,
                        );
                    }
                ...
                if (this.inscriptionEdit.reponses_questions.length > 0) {
                    await reponseQuestionOrganisateurService.saveReponses({
                        reponses: this.inscriptionEdit.reponses_questions.map(
                            (r) => ({
                                id_inscription: this.inscription.id,
                ...
                Object.assign(this.inscription, {
                    ...
                    choix_options: JSON.parse(
                        JSON.stringify(
                            this.inscriptionEdit.choix_options ?? [],
                        ),
                    ),
                    reponses_questions: JSON.parse(
                        JSON.stringify(
                            this.inscriptionEdit.reponses_questions ?? [],
                        ),
                    ),
                });
        ...
        optionSelectionnee(idOption) {
            return (
                (this.inscription.choix_options ?? []).find(
        ...
        optionSelectionneePourAffichage(idOption) {
            if (this.isEdit && this.inscriptionEdit) {
                return (
                    this.inscriptionEdit.choix_options.find(
                        (c) => c.id_option === idOption,
                    ) || null
                );
            }
        ...
        reponseQuestion(idQuestion) {
            const reponse = (this.inscription.reponses_questions ?? []).find(
                (r) => r.id_question === idQuestion,
            );
        ...
        reponseQuestionEdit(idQuestion, idOption) {
            if (this.isEdit && this.inscriptionEdit) {
                const reponse = this.inscriptionEdit.reponses_questions.find(
                    (r) => r.id_question === idQuestion,
                );
        ...
        selectionnerReponse(idQuestion, idOption) {
            const idx = this.inscriptionEdit.reponses_questions.findIndex(
                (r) => r.id_question === idQuestion,
            );
            if (idx > -1) {
                this.inscriptionEdit.reponses_questions[idx].id_option_choisie =
                    idOption;
            } else {
        ...
        async confirmerSuppressionDocument() {
            ...
            try {
                await documentService.deleteDocumentAdmin(
                    this.documentASupprimer,
                );
                const idx = (
                    this.inscription.documents_fournis ?? []
                ).findIndex((d) => d.id === this.documentASupprimer);
        ...
        estDocumentAutorise(fichier) {
            ...
            const estExtensionValide = extension
                ? extensionsAutorisees.includes(extension)
                : false;

            if (!estMimeValide && !estExtensionValide) {
                console.error(
                    "Type de fichier non autorisé : seuls les PDF, SVG, PNG et JPG sont acceptés.",
                );
                return false;
            }
        ...
        async uploadDocument(fichier) {
            try {
                ...
                const response = await documentService.uploadDocumentAdmin(
                    this.inscription.id,
                    formData,
                );
                if (!this.inscription.documents_fournis)
                    this.inscription.documents_fournis = [];
