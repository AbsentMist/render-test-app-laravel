    ...
    <div class="auth-bg min-h-screen flex items-center justify-center px-4">
        <div class="bg-white rounded-2xl shadow-xl w-full max-w-md p-8">
            ...
            <p class="text-center text-body mb-6">
                ...
                Veuillez entrer votre adresse email et votre mot de passe pour
                vous connecter.
            </p>
            ...
            <div class="space-y-4">
                <div>
                    <label class="text-label block mb-1"
                        >Votre adresse <span class="text-accent">*</span></label
                    >
                    <div class="relative">
                        <span
                ...
                <div class="text-center">
                    <router-link
                        ...
                        class="text-label underline text-primary hover:text-primary-300"
                    >
                        Mot de passe oublié?
                    </router-link>
                </div>
                ...
                <!-- Message d'erreur -->
                <p v-if="erreur" class="text-accent text-label text-center">
                    {{ erreur }}
                </p>
                ...
                <p class="text-center text-label">
                    ...
                    <router-link
                        to="/inscription"
                        class="text-accent underline hover:text-accent-600 ml-1"
                    >
                        Créer un compte
                    </router-link>
                </p>
            ...
            <div class="flex justify-center gap-12 mt-8">
                <router-link
                    to="/mentions-legales"
                    class="text-label underline hover:text-primary-300"
                >
                    Mentions légales
                </router-link>
                <router-link
